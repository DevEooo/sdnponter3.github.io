...
<head>
    ...
    <title>Login User | SDN Ponter 3</title>
    ...
    <div class="container">
        ...
        <div class="left" data-aos="fade-right">
            ...
            <div class="login-box">
                ...
                <form action="act_login.php" method="post" name="login">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="password" name="password" placeholder="user123" required>
                    </div>
                    <button type="submit" class="login-btn" name="login">Login</button>
                    <div class="regist-info">
                        <p>Belum punya akun? <a href="registerponter3.php" class="regist-btn">Register Disini!</a></p>
                    </div>
                </form>
            </div>
        </div>
        <div class="right">
            <a href="loginadmin.php" class="login-admin">Login Admin</a>
...
<script>
    ...
    const texts = ["Halo!", "Selamat Datang User!", "Silahkan login untuk memulai."];
    let textIndex = 0;
    let charIndex = 0;
    const speed = 120; 
    const eraseSpeed = 70; 
