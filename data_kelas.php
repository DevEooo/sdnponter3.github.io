...
<body>
    ...
    <br>
    <a href="add_form_kelas.php" method="post" class="add" data-aos="fade-up" data-aos-delay="300">Tambah Kelas</a>
    ...
    <table border="1" data-aos="fade-up" data-aos-delay="500">
        ...
        while ($row = mysqli_fetch_assoc($query)) {
            ...
            <tr>
                ...
                <td>
                    <a href="edit_form_kelas.php?id=<?= $row['id_kelas'] ?>" class="edit-btn">Edit</a>
                    <a href="delete_kelas.php?id=<?= $row['id_kelas'] ?>"
