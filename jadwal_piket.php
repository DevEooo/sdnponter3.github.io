...
<body>
    <nav>
        ...
        <ul>
            ...
            <li><a href="jadwal_piket.php" class="btnhome">Jadwal Piket</a></li>
    ...
    <a href="add_form_jadwal.php" method="post" class="add" data-aos="fade-up" data-aos-delay="300">Tambah Jadwal Piket</a>
    ...
    <table border="1" data-aos="fade-up" data-aos-delay="700">
        ...
        while ($row = mysqli_fetch_assoc($query)) {
            ...
            <tr>
                ...
                <td>
                    <a href="edit_form_jadwal.php?id=<?= $row['id_jadwal'] ?>" class="edit-btn">Edit</a>
                    <a href="delete_jadwal.php?id=<?= $row['id_jadwal'] ?>"
